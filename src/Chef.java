...
public class Chef extends Employee implements AccountInt {
    ...
    public Chef(String name, String phone, String email, int employeeID, Date dateJoined, String position, double salary, String department, EmployeeStatus status, Account account) {
